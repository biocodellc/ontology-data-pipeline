...
def test_should_generate_valid_triples(config):
    ...
    expected_triples = [
        ...
        '<http://n2t.net/ark:/21547/Anm21> <http://rs.tdwg.org/dwc/terms/EventID> "1"',
        '<http://n2t.net/ark:/21547/Anm21> <http://rs.tdwg.org/dwc/terms/decimalLatitude> "-12.99"',
        '<http://n2t.net/ark:/21547/Anm21> <http://rs.tdwg.org/dwc/terms/decimalLongitude> "13.0"',
        '<http://n2t.net/ark:/21547/Anm21> <http://rs.tdwg.org/dwc/terms/year> "1988"',
        '<http://n2t.net/ark:/21547/Anm21> <http://rs.tdwg.org/dwc/terms/startDayOfYear> "120"',
        '<http://n2t.net/ark:/21547/Anm21> <http://purl.org/dc/elements/1.1/creator> "me"',
